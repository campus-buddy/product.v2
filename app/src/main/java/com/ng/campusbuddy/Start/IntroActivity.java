...
import com.ng.campusbuddy.Tools.IntroViewPagerAdapter;
import com.ng.campusbuddy.Tools.ScreenItem;
...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (restorePrefData()) {
            ...
            Intent welcome = new Intent(getApplicationContext(), StartActivity.class );
